...
AppVerName=ASCOM SkyHat Dome Driver 1.7
AppVersion=1.7.0
...
OutputDir="."
OutputBaseFilename="SkyHat-1.7-ASCOM-Setup"
Compression=lzma
...
[Files]
Source: "C:\files\Продукты\Мотомаска\ASCOM\SkyHat\bin\Debug\ASCOM.SkyHat.Dome.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\files\Продукты\Мотомаска\ASCOM\SkyHat\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
