...
; Generated by Oleg Milantiev on 25.03.2020 (UTC)
; Качай InnoSetup Installer Tool из https://jrsoftware.org/isinfo.php и запускай с этим ISS
;
[Setup]
AppID={{6f9b5058-6251-49f3-a830-a577333d0981}
AppName=ASCOM SkyHat Dome Driver
AppVerName=ASCOM SkyHat Dome Driver 2.0.0
AppVersion=2.0.0
...
OutputDir="."
OutputBaseFilename="SkyHat-2.0.0-ASCOM-Dome-Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\SkyHat"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\SkyHat"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\files\Продукты\SkyHat\ASCOM\SkyHat\bin\Debug\ASCOM.SkyHat.Dome.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\files\Продукты\SkyHat\ASCOM\SkyHat\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SkyHat.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SkyHat.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SkyHat.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SkyHat.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SkyHat.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
